    ...
    def game_screen_loop(self, ans, start1, start2):
        ...
        while self.STATE == "game":
            ...
            if (proceed):
                ...
                self.text_left= TextDisplay.TextDisplay(self.display, text="", x = self.center_w-self.center_w/2-140, y = self.center_h-240)
                self.text_right= TextDisplay.TextDisplay(self.display, text="", x = self.center_w+self.center_w/2-140, y = self.center_h-240)
